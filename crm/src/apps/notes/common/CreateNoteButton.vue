...
const notesDialog = inject('notesDialog', {
	...
	createWithType: () => console.warn('Notes dialog createWithType API not available'),
	setContext: () => {},
})
...
function openNoteCreator(event) {
	if (props.type) {
...
function createNote(type) {
	...
	// Use the notesDialog.createWithType API directly
	// This will open the dialog with the specified note type
