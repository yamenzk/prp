  ...
  <div class="pd-panel">
    ...
    <div v-else class="pd-panel-content pd-scrollable">
      <div 
        ...
        :class="{ 'pd-selected': selectedBuilding && selectedBuilding.name === building.name }"
...
const menuItems = computed(() => {
  const items = [
    ...
    },
    {
      label: 'Add Listing',
      icon: 'pi pi-plus',
      command: () => emitter.emit('show-create-listing', { building: selectedBuilding.value })
    }
  ];
